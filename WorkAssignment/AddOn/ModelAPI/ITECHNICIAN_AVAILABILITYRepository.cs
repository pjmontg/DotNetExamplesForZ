// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="ITECHNICIAN_AVAILABILITYRepository.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/branches/Release/81/WebApp/Plugin_WorkAssignment/ModelAPI/ITECHNICIAN_AVAILABILITYRepository.cs $
//   $LastChangedRevision: 8139 $ 
//   $LastChangedDate: 2013-07-26 14:04:08 -0700 (Fri, 26 Jul 2013) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Interface to technician's availability from a data source  
// </summary> 
// ------------------------------------------------------------- 
...
{   
	/// <summary>
	/// Interface for TECHNICIAN_AVAILABILITY Repository
	/// </summary>
	public interface ITECHNICIAN_AVAILABILITYRepository : IRepository<TECHNICIAN_AVAILABILITY>
	{
