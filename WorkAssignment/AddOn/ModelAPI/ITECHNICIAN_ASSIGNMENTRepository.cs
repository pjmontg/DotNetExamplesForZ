// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="ITECHNICIAN_ASSIGNMENTRepository.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/branches/Release/81/WebApp/Plugin_WorkAssignment/ModelAPI/ITECHNICIAN_ASSIGNMENTRepository.cs $
//   $LastChangedRevision: 8170 $ 
//   $LastChangedDate: 2013-07-30 16:13:42 -0700 (Tue, 30 Jul 2013) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Interface to technician's assignments for activities from a data source  
// </summary> 
// ------------------------------------------------------------- 
...
{   
	/// <summary>
	/// Interface for TECHNICIAN_ASSIGNMENT Repository
	/// </summary>
	public interface ITECHNICIAN_ASSIGNMENTRepository : IRepository<TECHNICIAN_ASSIGNMENT>
	{

        TECHNICIAN_ASSIGNMENT GetAssignment(decimal activityId, decimal techId, DateTime workDate);

        IList<TECHNICIAN_ASSIGNMENT> GetAssignments(decimal activityId, string shopId, DateTime workDate);
    }
}