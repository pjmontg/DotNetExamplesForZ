// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IVW_TECHNICIAN_AVAILABILITYRepository.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/branches/Release/81/WebApp/Plugin_WorkAssignment/ModelAPI/IVW_TECHNICIAN_AVAILABILITYRepository.cs $
//   $LastChangedRevision: 8161 $ 
//   $LastChangedDate: 2013-07-30 08:27:48 -0700 (Tue, 30 Jul 2013) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Interface to technician's availabilities from a data source  
// </summary> 
// ------------------------------------------------------------- 
...
{   
	/// <summary>
	/// Interface for VW_TECHNICIAN_AVAILABILITY Repository
	/// </summary>
	public interface IVW_TECHNICIAN_AVAILABILITYRepository : IRepository<VW_TECHNICIAN_AVAILABILITY>
	{

        IList<VW_TECHNICIAN_AVAILABILITY> GetAll(string shopId, DateTime workdate);
    }
}