// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IVW_TECHNICIAN_UTILIZATIONRepository.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/branches/Release/81/WebApp/Plugin_WorkAssignment/ModelAPI/IVW_TECHNICIAN_UTILIZATIONRepository.cs $
//   $LastChangedRevision: 8163 $ 
//   $LastChangedDate: 2013-07-30 10:12:07 -0700 (Tue, 30 Jul 2013) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Interface to technician's utilization from a data source  
// </summary> 
// ------------------------------------------------------------- 
...
{   
	/// <summary>
	/// Interface for VW_TECHNICIAN_UTILIZATION Repository
	/// </summary>
	public interface IVW_TECHNICIAN_UTILIZATIONRepository : IRepository<VW_TECHNICIAN_UTILIZATION>
	{
        /// <summary>
        ...
        List<VW_TECHNICIAN_UTILIZATION> GetAll(DateTime? workDate, string shop);
	}
}