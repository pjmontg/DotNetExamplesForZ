// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="TECHNICIANRepository.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/branches/Release/81/WebApp/Plugin_WorkAssignment/Model/TECHNICIANRepository.cs $
//   $LastChangedRevision: 9794 $ 
//   $LastChangedDate: 2013-12-16 14:13:21 -0800 (Mon, 16 Dec 2013) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Provides access to technicians from an Oracle database  
// </summary> 
// ------------------------------------------------------------- 
...
{   
	...
	/// </summary>
	public partial class TECHNICIANRepository : EFRepository<TECHNICIAN>, ITECHNICIANRepository
	{
        ...
        [InjectionMethod]
        public void Initialize(ILogger<TECHNICIANRepository> logger)
        {
            _logger = logger;
        ...
        public List<TECHNICIAN> GetAllByShopId(string shopId)
        {
            ...
            try
            {
                var query = this.Where(x => x.SHOP_ID == shopId);
        ...
        /// Logger for logging
        /// </summary>
        private static ILogger<TECHNICIANRepository> _logger = null;
        #endregion       
	}
}