// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="PluginInstallerException.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Exception/PluginInstallerException.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Exception which occurs on installing plugin
// </summary> 
// ------------------------------------------------------------- 

namespace PluginAPI.Exception
{
    public class PluginInstallerException : System.Exception
    {
        ...
        public PluginInstallerException(string message, System.Exception e)
            : base(message, e)
        {
