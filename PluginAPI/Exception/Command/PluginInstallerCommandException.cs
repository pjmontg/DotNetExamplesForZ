// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="PluginInstallerCommandException.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Exception/Command/PluginInstallerCommandException.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Exception which occurs on plugin command installer
// </summary> 
// ------------------------------------------------------------- 

namespace PluginAPI.Exception.Command
{
    public class PluginInstallerCommandException : System.Exception
    {
        public PluginInstallerCommandException(string message)
            : base(message)
        {

        }

        public PluginInstallerCommandException(string message, System.Exception e)
            : base(message, e)
        {
