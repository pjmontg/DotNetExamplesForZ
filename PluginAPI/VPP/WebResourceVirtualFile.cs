// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="WebResourceVirtualFile.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/VPP/WebResourceVirtualFile.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Class for Web Resource Virtual File
// </summary> 
// -------------------------------------------------------------


using System.IO;
using Utilities.VirtualPaths;

namespace PluginAPI.VPP
{
    public class WebResourceVirtualFile : System.Web.Hosting.VirtualFile
    {
        ...
        {
            Stream st;
            string asmPath = Util.GetAssemblyPathFromVirtualPath(this._assembly.GetName().Name, this._pagePath, this._baseVirtualPath);
            st = this._assembly.GetManifestResourceStream(asmPath);

            return st;
        }

        public WebResourceVirtualFile(string pagePath, string baseVirtualPath, System.Reflection.Assembly assembly)
            : base(pagePath)
        {
