// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IPlugin.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/IPlugin.cs $
...
namespace PluginAPI
{
    ...
    {
        Queue<IPluginInstallerCommand> InstallerCommands { get; }
        IPluginStateCommand StateCommand { get; }
