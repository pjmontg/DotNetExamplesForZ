// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="WebResourceProviderPluginChildPageAttribute.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Attributes/WebResourceProviderPluginChildPageAttribute.cs $
//   $LastChangedRevision: 10888 $ 
//   $LastChangedDate: 2014-03-25 09:53:14 -0700 (Tue, 25 Mar 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Attribute for resource provider plugin child page
// </summary> 
// ------------------------------------------------------------- 
...
namespace PluginAPI.Attributes
{
    ...
    public class WebResourceProviderPluginChildPageAttribute : AbstractWebResourceProviderPluginAttribute
    {
        private string _url;
        private string _title;
        private string _description;

        public WebResourceProviderPluginChildPageAttribute(string baseVirtualPath, string url, string title, string description)
