// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="PluginRoleNameAttribute.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Attributes/PluginRoleNameAttribute.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Attribute for plugin role name
// </summary> 
// ------------------------------------------------------------- 
...
namespace PluginAPI.Attributes
{
    ...
    public class PluginRoleNameAttribute : Attribute
    {
        private string _role;
        public PluginRoleNameAttribute(string role)
        {
            this._role = role;
        }
