// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="PluginWebResourceAttribute.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Attributes/PluginWebResourceAttribute.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Attribute for plugin web resource
// </summary> 
// ------------------------------------------------------------- 
...
namespace PluginAPI.Attributes
{
    ...
    public class PluginWebResourceAttribute : Attribute
    {
        private string _url;

        public PluginWebResourceAttribute(string url)
        {
            this._url = url;
        }
