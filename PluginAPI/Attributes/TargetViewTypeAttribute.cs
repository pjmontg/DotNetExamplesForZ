// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="TargetViewTypeAttribute.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Attributes/TargetViewTypeAttribute.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Attribute for target view type
// </summary> 
// ------------------------------------------------------------- 
...
namespace PluginAPI.Attributes
{
    ...
    public class TargetViewTypeAttribute : Attribute
    {
        private string _type;
        public TargetViewTypeAttribute(string type)
        {
            this._type = type;
        }
