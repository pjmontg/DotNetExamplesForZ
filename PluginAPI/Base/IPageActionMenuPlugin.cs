// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IPageActionMenuPlugin.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Base/IPageActionMenuPlugin.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Page Action Menu Plugin Interface
// </summary> 
// ------------------------------------------------------------- 
...
{
    public interface IPageActionMenuPlugin : IPlugin
    {
        void InitializePluginControls(Control container);
        IList<RadMenuItem> BuildMenuItems();
        bool HandleMenuAction(object sender, RadMenuEventArgs e);
    }
}
