// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IWebResourceProviderPlugin.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Base/IWebResourceProviderPlugin.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Web Resource Provider Plugin Interface
// </summary> 
// ------------------------------------------------------------- 
...
{
    public interface IWebResourceProviderPlugin : IPlugin
    {
        WebResourceVirtualPathProvider VirtualPathProvider { get; }
