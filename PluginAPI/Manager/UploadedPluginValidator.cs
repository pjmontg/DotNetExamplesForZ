// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="UploadedPluginValidator.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Manager/UploadedPluginValidator.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Class for validating uploaded plugin
// </summary> 
// -------------------------------------------------------------
...
{
    public class UploadedPluginValidator
    {
        ...
        public UploadedPluginValidator(byte[] assemblyStream) {
            this._assemblyStream = assemblyStream;
        }
        ...
        public bool IsValid()
        {
            ...
            try
            {
                Assembly uploadedAssembly = Assembly.Load(this._assemblyStream);
                ...
                if (null != _plugin)
                {
                    ...
                    PluginDescription = _plugin.Metadata.Description;
                }
                container.Dispose();
            }
            catch (System.Exception e)
            {
                ValidationErrorMessage = "The selected file is not a valid add-on. " + e.Message;
            }
