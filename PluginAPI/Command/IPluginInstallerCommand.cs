// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="IPluginInstallerCommand.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Command/IPluginInstallerCommand.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//  PluginInstallerCommand Interface
// </summary> 
// ------------------------------------------------------------- 
...
{
    public interface IPluginInstallerCommand
    {
        void CheckPreconditions(IPluginService PluginService);
        void Execute(IPluginService PluginService);
        void Rollback(IPluginService PluginService);
        void Validate(IPluginService PluginService);
    }
}
