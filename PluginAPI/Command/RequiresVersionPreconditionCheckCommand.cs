// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="RequiresVersionPreconditionCheckCommand.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Command/RequiresVersionPreconditionCheckCommand.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Class for Precondition which Requires Version Check Command
// </summary> 
// ------------------------------------------------------------- 
...
{
    internal class RequiresVersionPreconditionCheckCommand : AbstractCheckGlobalPreconditionCommand
    {
        public override void Validate(IPluginService PluginService)
        {
            if (!String.Equals(ApplicationVersion, RequiresVersion, StringComparison.InvariantCultureIgnoreCase))
            {
                throw new PluginInstallerCommandException("This plugin requires Syntempo Version " + RequiresVersion + ". The current version of Syntempo is " + ApplicationVersion + ".");
            }
        }
