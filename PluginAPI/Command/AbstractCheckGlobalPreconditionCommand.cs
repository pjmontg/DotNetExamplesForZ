// -------------------------------------------------------------
// <copyright company="Pipeline Group, Inc." file="AbstractCheckGlobalPreconditionCommand.cs">
// COPYRIGHT NOTICE
...
// <remarks>
//   $HeadURL: https://pipesvn.pipelinenetwork.com/svn/STP/Product/trunk/WebApp/PluginAPI/Command/AbstractCheckGlobalPreconditionCommand.cs $
//   $LastChangedRevision: 10641 $ 
//   $LastChangedDate: 2014-02-19 15:14:06 -0800 (Wed, 19 Feb 2014) $ 
//   $LastChangedBy: pmontgomery $ 
// </remarks>  
// <summary>  
//   Abstract example of CheckGlobalPreconditionCommand
// </summary> 
// ------------------------------------------------------------- 
...
{
    public abstract class AbstractCheckGlobalPreconditionCommand : IPluginInstallerCommand
    {
        ...
        public abstract void Validate(IPluginService PluginService);
    }
}
